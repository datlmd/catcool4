<script type="text/javascript" src="{base_url('common/js/iconpicker/iconpicker.js')}"></script>
<script type="text/javascript" src="{base_url('common/js/admin/filemanager.js')}"></script>
