			...
			<div class="col-12">
				...
				<div class="row">
					...
					<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
						...
						{include file=get_theme_path('views/inc/button_translate.tpl') translate_frontend=lang('SubscriptionPlanAdmin.translate_frontend_id') translate_admin=lang('SubscriptionPlanAdmin.translate_admin_id')}
					</div>
				</div>

				<div class="card">
					<h5 class="card-header"><i class="fas fa-list me-2"></i>{lang('SubscriptionPlanAdmin.text_list')}</h5>
					<div id="plan" class="card-body">

						{include file=get_theme_path('views/modules/subscriptions/plans/list.tpl')}
