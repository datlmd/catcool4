            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            {lang('text_symbol_left', 'text_symbol_left', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" name="symbol_left" value="{set_value('symbol_left', $edit_data.symbol_left)}" id="symbol_left" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            {lang('text_symbol_right', 'text_symbol_right', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" name="symbol_right" value="{set_value('symbol_right', $edit_data.symbol_right)}" id="symbol_right" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            {lang('text_decimal_place', 'text_decimal_place', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            {lang('text_value', 'text_value', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
                            <div class="col-12 col-sm-8 col-lg-6">
