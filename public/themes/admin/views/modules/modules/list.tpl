...
<div class="container-fluid  dashboard-content">
	<div class="row">
		...
		<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
			...
			<a href="{site_url($manage_url)}/add" class="btn btn-sm btn-primary btn-space" title="{lang('ModuleAdmin.text_add')}"><i class="fas fa-plus me-1"></i>{lang('ModuleAdmin.text_add')}</a>
			...
			<div class="card">
				...
				<div class="card-body">
					{if !empty($list)}
						...
						{include file=get_theme_path('views/inc/paging.tpl') pager_name='modules'}
					{else}
