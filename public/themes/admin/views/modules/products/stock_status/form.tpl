...
<div class="container-fluid  dashboard-content">
    {form_open(uri_string(), ['id' => 'validationform'])}
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <h5 class="card-header"><i class="fas {if !empty($edit_data.stock_status_id)}fa-edit{else}fa-plus{/if} mr-2"></i>{$text_form}</h5>
                    ...
                    <div class="card-body border-top">
                        <div class="form-group row">
                            <label class="col-12 col-sm-3 col-form-label required-label text-sm-right">{lang('text_published')}</label>
                            <div class="col-12 col-sm-8 col-lg-7 pt-1">
                                <div class="switch-button switch-button-xs mt-1">
                                    <input type="checkbox" name="published" value="{STATUS_ON}" {if $edit_data.stock_status_id}{if $edit_data.published eq true}checked="checked"{/if}{else}checked="checked"{/if} id="published">
