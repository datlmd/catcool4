                                        ...
                                        <div class="tab-pane fade {if !empty($language.active)}show active{/if}" role="tabpanel" id="lanuage_content_{$language.id}"  aria-labelledby="language_tab_{$language.id}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-7">
                                                    ...
                                                    {/if}
                                                    <input type="text" name="lang[{$language.id}][unit]" value="{old("lang.{$language.id}.unit", $unit)}" id="input_unit_{$language.id}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    {/foreach}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="form-label">{lang('ProductWeightClassAdmin.text_value')}</label>
