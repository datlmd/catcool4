{strip}
	...
	<div class="form-group row">
		...
		<div class="col-12 col-sm-10 col-lg-10">
			<div class="input-group date show-date-picker" id="show_date_available" data-target-input="nearest" data-date-format="DD/MM/YYYY" data-date-locale="{get_lang(true)}">
				<input type="text" name="date_available" id="input_date_available" class="form-control datetimepicker-input" value="{old('date_available', $edit_data.date_available|default:get_date())|date_format:'d/m/Y'}" placeholder="dd/mm/yyyy" data-target="#show_date_available" />
