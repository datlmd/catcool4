{strip}
    ...
    {if !empty($product_variant_option_value.option_value_id)}
        <input type="hidden" name="product_variant[{$vf_variant_option_row}][option_values][{$vf_variant_option_value_row}][option_value_id]" value="{$product_variant_option_value.option_value_id}"/>
    {/if}
    ...
    <div id="product_variant_option_row_{$vf_variant_option_row}" data-row="{$vf_variant_option_row}" class="product-variant-option rounded bg-light p-3">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <select name="product_variant[{$vf_variant_option_row}][option_id]" id="input_product_variant_{$vf_variant_option_row}_option_id" class="form-select">
