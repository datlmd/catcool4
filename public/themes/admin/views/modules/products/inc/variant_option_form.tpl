        ...
        <div class="flex-grow-1">
            {foreach $language_list as $language}
                <div class="input-group {if !$language@last}mb-2{/if}">
                    ...
                    <input type="text" name="product_variant[{$product_variant_option_row}][option_values][{$product_variant_option_value_row}][lang][{$language.id}][name]"
                           id="input_product_variant_{$product_variant_option_row}_option_values_{$product_variant_option_value_row}_lang_{$language.id}_name"
                           class="form-control variant-option-name {if $language@first}default{/if}"
                           value="{old("product_variant[{$product_variant_option_row}][option_values][{$product_variant_option_value_row}][lang][{$language.id}][name]", $product_variant_option_value.lang.{$language.id}.name)|default:""}"
                           data-varian-option-row="{$product_variant_option_row}" data-variant-option-value-row="{$product_variant_option_value_row}"
                ...
                <div id="error_product_variant_{$product_variant_option_row}_option_values_{$product_variant_option_value_row}_lang_{$language.id}_name" class="invalid-feedback"></div>
            {/foreach}
        </div>
