			...
			<div class="col-xl-10 col-lg-10 col-md-9 col-sm-12 col-12">
				...
				<div class="row">
					...
					<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
						...
						{include file=get_theme_path('views/inc/button_translate.tpl') translate_frontend=lang('ProductOrderStatusAdmin.translate_frontend_id') translate_admin=lang('ProductOrderStatusAdmin.translate_admin_id')}
					</div>
				</div>

				<div class="card">
					<h5 class="card-header"><i class="fas fa-list me-2"></i>{lang('ProductOrderStatusAdmin.text_list')}</h5>
					<div class="card-body">
						{if !empty($list)}
