				...
				<div class="card-body px-0 pb-0 pt-3 bg-light">
					...
					<div class="tab-regular">
						<ul class="nav nav-tabs border-bottom ps-3" id="config_tab" role="tablist">
							<li class="nav-item">
								<a class="nav-link p-2 ps-3 pe-3 {if $tab_type eq 'tab_page'}active{/if}" id="tab_page" data-bs-toggle="tab" href="#tab_content_page" role="tab" aria-controls="tab_page" aria-selected="{if $tab_type eq 'tab_page'}true{else}false{/if}">{lang('tab_general')}</a>
							</li>
							<li class="nav-item">
								<a class="nav-link p-2 ps-3 pe-3 {if $tab_type eq 'tab_image'}active{/if}" id="tab_image" data-bs-toggle="tab" href="#tab_content_image" role="tab" aria-controls="tab_image" aria-selected="{if $tab_type eq 'tab_image'}true{else}false{/if}">{lang('tab_image')}</a>
							</li>
							<li class="nav-item">
								<a class="nav-link p-2 ps-3 pe-3 {if $tab_type eq 'tab_local'}active{/if}" id="tab_local" data-bs-toggle="tab" href="#tab_content_local" role="tab" aria-controls="tab_local" aria-selected="{if $tab_type eq 'tab_local'}true{else}false{/if}">{lang('tab_local')}</a>
							</li>
							<li class="nav-item">
								<a class="nav-link p-2 ps-3 pe-3 {if $tab_type eq 'tab_option'}active{/if}" id="tab_option" data-bs-toggle="tab" href="#tab_content_option" role="tab" aria-controls="tab_option" aria-selected="{if $tab_type eq 'tab_option'}true{else}false{/if}">{lang('tab_option')}</a>
							</li>
							<li class="nav-item">
								<a class="nav-link p-2 ps-3 pe-3 {if $tab_type eq 'tab_mail'}active{/if}" id="tab_mail" data-bs-toggle="tab" href="#tab_content_mail" role="tab" aria-controls="tab_mail" aria-selected="{if $tab_type eq 'tab_mail'}true{else}false{/if}">{lang('tab_mail')}</a>
							</li>
							<li class="nav-item">
								<a class="nav-link p-2 ps-3 pe-3 {if $tab_type eq 'tab_server'}active{/if}" id="tab_server" data-bs-toggle="tab" href="#tab_content_server" role="tab" aria-controls="tab_server" aria-selected="{if $tab_type eq 'tab_server'}true{else}false{/if}">{lang('tab_server')}</a>
							</li>
						</ul>
