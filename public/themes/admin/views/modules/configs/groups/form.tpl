    ...
    {form_open(uri_string(), ['id' => 'validationform'])}
        <div class="row">
            ...
            <div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
                ...
                <a href="{base_url($manage_url)}{http_get_query()}" class="btn btn-sm btn-space btn-secondary me-0 mb-0" title="{lang('Admin.button_cancel')}"><i class="fas fa-reply me-1"></i>{lang('Admin.button_cancel')}</a>
            </div>
        </div>
