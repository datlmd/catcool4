...
<div class="form-group row">
	{lang('text_file_max_size', 'text_file_max_size', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
...
<div class="form-group row">
	{lang('text_file_ext_allowed', 'text_file_ext_allowed', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row d-none">
	{lang('text_file_mime_allowed', 'text_file_mime_allowed', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_file_max_width', 'text_file_max_width', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_file_max_height', 'text_file_max_height', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_file_encrypt_name', 'text_file_encrypt_name', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_image_none', 'text_image_none', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<a href="javascript:void(0);" id="image_none" data-target="input_image_none" data-thumb="load_image_none" data-bs-toggle="image" class="mx-0 mt-1">
			<img src="{if !empty(set_value('image_none', $settings.image_none))}{image_thumb_url(set_value('image_none', $settings.image_none))}{else}{image_default_url()}{/if}" class="img-thumbnail w-100 me-1 img-fluid" alt="" title="" id="load_image_none" data-placeholder="{image_default_url()}"/>
			<button type="button" id="button-image-none" class="button-image btn btn-xs btn-primary w-100 mt-1"><i class="fas fa-pencil-alt me-1"></i>{lang('text_photo_edit')}</button>
			<button type="button" id="button-clear-none" class="button-clear btn btn-xs btn-danger w-100 mt-1 mb-1"><i class="fas fa-trash me-1"></i>{lang('text_photo_clear')}</button>
		</a>
		<input type="hidden" name="image_none" value="{set_value('image_none', $settings.image_none)}" id="input_image_none" />
	</div>
</div>
<div class="form-group row">
	{lang('text_image_quality', 'text_image_quality', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		{form_dropdown('image_quality', $image_quality_list, set_value('image_quality', $settings.image_quality), ['class' => 'form-control'])}
	</div>
</div>
<div class="form-group row">
	{lang('text_enable_resize_image', 'text_enable_resize_image', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_image_thumbnail_large', 'text_image_thumbnail_large', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
...
<div class="form-group row">
	{lang('text_image_thumbnail_small', 'text_image_thumbnail_small', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_image_watermark', 'text_image_watermark', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6 bg-light p-4">
		...
		<ul class="nav nav-tabs border-bottom ps-3 mt-4" id="image_watermark_tab" role="tablist">
			<li class="nav-item">
				<a class="nav-link p-2 ps-3 pe-3 {if empty($settings.image_watermark_path)}active{/if}" id="tab_image_watermark_text" data-bs-toggle="tab" href="#tab_content_image_watermark_text" role="tab" aria-controls="tab_image_watermark_text" aria-selected="{if empty($settings.image_watermark_path)}true{else}false{/if}">{lang('text_image_watermark_text')}</a>
			</li>
			<li class="nav-item">
				<a class="nav-link p-2 ps-3 pe-3 {if !empty($settings.image_watermark_path)}active{/if}" id="tab_image_watermark_path" data-bs-toggle="tab" href="#tab_content_image_watermark_path" role="tab" aria-controls="tab_image_watermark_path" aria-selected="{if !empty($settings.image_watermark_path)}true{else}false{/if}">{lang('text_image_watermark_path')}</a>
			</li>
		</ul>
			...
			<div class="tab-pane fade {if !empty($settings.image_watermark_path)}show active{/if}" role="tabpanel" id="tab_content_image_watermark_path"  aria-labelledby="tab_image_watermark_path">
				<div class="form-group">
					<a href="javascript:void(0);" id="image_watermark_path" data-target="input_image_watermark_path" data-thumb="load_image_watermark_path" data-bs-toggle="image" class="mx-0 mt-1">
						<img src="{if !empty(set_value('image_watermark_path', $settings.image_watermark_path))}{image_thumb_url(set_value('image_watermark_path', $settings.image_watermark_path))}{else}{image_default_url()}{/if}" class="img-thumbnail w-100 me-1 img-fluid" alt="" title="" id="load_image_watermark_path" data-placeholder="{image_default_url()}"/>
						<button type="button" id="button-image-watemark" class="button-image btn btn-xs btn-primary w-100 mt-1"><i class="fas fa-pencil-alt me-1"></i>{lang('text_photo_edit')}</button>
						<button type="button" id="button-clear-watemark" class="button-clear btn btn-xs btn-danger w-100 mt-1 mb-1"><i class="fas fa-trash me-1"></i>{lang('text_photo_clear')}</button>
					</a>
...
<div class="form-group row d-none">
	...
	<div class="col-12 col-sm-8 col-lg-6">
		...
		<a href="javascript:void(0);" id="file_pdf" data-target="input_file_pdf" data-bs-toggle="image" class="mx-0 mt-1">
			<button type="button" id="button-image-pdf" class="button-image btn btn-xs btn-primary w-100 mt-1"><i class="fas fa-pencil-alt me-1"></i>{lang('text_photo_edit')}</button>
		</a>
	</div>
</div>
