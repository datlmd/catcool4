...
<div class="form-group row">
	{lang('text_email_engine', 'text_email_engine', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
...
<div class="form-group row">
	{lang('text_email_parameter', 'text_email_parameter', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_email_host', 'text_email_host', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_email_smtp_user', 'text_email_smtp_user', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_email_smtp_pass', 'text_email_smtp_pass', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_email_port', 'text_email_port', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<input type="text" name="email_port" value="{set_value('email_port', $settings.email_port)}" id="email_port" class="form-control">
	</div>
</div>
<div class="form-group row">
	{lang('text_email_smtp_timeout', 'text_email_smtp_timeout', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_email_subject_title', 'text_email_subject_title', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_email_from', 'text_email_from', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_email_alert', 'text_email_alert', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_email_alert_email', 'text_email_alert_email', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
	<div class="col-12 col-sm-8 col-lg-6">
