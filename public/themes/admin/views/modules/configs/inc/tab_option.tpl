...
<div class="form-group row">
	{lang('text_product_count', 'text_product_count', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
...
<div class="form-group row">
	{lang('text_product_limit_admin', 'text_product_limit_admin', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_review_status', 'text_review_status', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_review_guest', 'text_review_guest', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_product_voucher_min', 'text_product_voucher_min', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_product_voucher_max', 'text_product_voucher_max', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_tax', 'text_tax', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_tax_default', 'text_tax_default', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_tax_customer', 'text_tax_customer', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_customer_online', 'text_customer_online', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_customer_activity', 'text_customer_activity', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_customer_search', 'text_customer_search', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_customer_group_id', 'text_customer_group_id', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_customer_group_display', 'text_customer_group_display', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_customer_price', 'text_customer_price', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_login_attempts', 'text_login_attempts', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_account_terms', 'text_account_terms', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_invoice_prefix', 'text_invoice_prefix', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_cart_weight', 'text_cart_weight', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_checkout_guest', 'text_checkout_guest', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_checkout_terms', 'text_checkout_terms', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_order_status_id', 'text_order_status_id', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_processing_status', 'text_processing_status', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_complete_status', 'text_complete_status', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_fraud_status_id', 'text_fraud_status_id', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_order_api_id', 'text_order_api_id', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_stock_display', 'text_stock_display', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_stock_warning', 'text_checkout_guest', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_stock_checkout', 'text_stock_checkout', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_affiliate_group_id', 'text_affiliate_group_id', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_affiliate_approval', 'text_affiliate_approval', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_affiliate_auto', 'text_affiliate_auto', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_affiliate_commission', 'text_affiliate_commission', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_affiliate_terms', 'text_affiliate_terms', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_return_terms', 'text_return_terms', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_return_status_id', 'text_return_status_id', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_is_captcha', 'text_is_captcha', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		<div class="switch-button switch-button-xs mt-2">
...
<div class="form-group row">
	{lang('text_captcha_page', 'text_captcha_page', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
