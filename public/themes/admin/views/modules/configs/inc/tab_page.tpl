...
<div class="form-group row">
	...
	<div class="col-12 col-sm-8 col-lg-6">
		{if !empty($settings.site_name)}
			{assign var="site_name" value="`$settings.site_name`"}
		{else}
			{assign var="site_name" value=""}
		{/if}
		<input type="text" name="site_name" value="{old('site_name', $site_name)}" id="site_name" class="form-control {if $validator->hasError("site_name")}is-invalid{/if}">
...
<div class="form-group row">
	...
	<div class="col-12 col-sm-8 col-lg-6">
		{if !empty($settings.site_description)}
			{assign var="site_description" value="`$settings.site_description`"}
		{else}
			{assign var="site_description" value=""}
		{/if}
		<textarea type="textarea" name="site_description" id="site_description" cols="40" rows="5" class="form-control {if $validator->hasError("site_description")}is-invalid{/if}">{old('site_description', $site_description)}</textarea>
		<div class="invalid-feedback">
...
<div class="form-group row">
	...
	<div class="col-12 col-sm-8 col-lg-6">
		{if !empty($settings.site_keywords)}
			{assign var="site_keywords" value="`$settings.site_keywords`"}
		{else}
			{assign var="site_keywords" value=""}
		{/if}
		<input type="text" name="site_keywords" value="{old('site_keywords', $site_keywords)}" id="site_keywords" class="form-control {if $validator->hasError("site_keywords")}is-invalid{/if}">
		<div class="invalid-feedback">
...
<div class="form-group row">
	...
	<div class="col-12 col-sm-8 col-lg-6">
		{if !empty($settings.image_logo_url)}
			{assign var="image_logo_url" value="`$settings.image_logo_url`"}
		{else}
			{assign var="image_logo_url" value=""}
		{/if}
		<a href="javascript:void(0);" id="image_logo_url" data-target="input_image_logo_url" data-thumb="load_image_logo_url" data-type="image" data-bs-toggle="image" class="mx-0 mt-1">
			<img src="{if !empty(old('image_logo_url', $settings.image_logo_url))}{image_thumb_url(old('image_logo_url', $image_logo_url))}{else}{image_default_url()}{/if}" class="img-thumbnail w-100 me-1 img-fluid" alt="" title="" id="load_image_logo_url" data-placeholder="{image_default_url()}"/>
		...
		<input type="hidden" name="image_logo_url" value="{old('image_logo_url', $image_logo_url)}" id="input_image_logo_url" />
	</div>
</div>
<div class="form-group row">
	<div class="col-12 col-sm-3 col-form-label text-sm-end">{lang('ConfigAdmin.text_icon')}</div>
	<div class="col-12 col-sm-8 col-lg-6">
		{if !empty($settings.image_icon_url)}
			{assign var="image_icon_url" value="`$settings.image_icon_url`"}
		{else}
			{assign var="image_icon_url" value=""}
		{/if}
		<a href="javascript:void(0);" id="image_icon_url" data-target="input_image_icon_url" data-thumb="load_image_icon_url" data-type="image" data-bs-toggle="image" class="mx-0 mt-1">
			<img src="{if !empty(old('image_icon_url', $settings.image_icon_url))}{image_thumb_url(old('image_icon_url', $image_icon_url))}{else}{image_default_url()}{/if}" class="img-thumbnail w-100 me-1" alt="" title="" id="load_image_icon_url" data-placeholder="{image_default_url()}"/>
		...
		<input type="hidden" name="image_icon_url" value="{old('image_icon_url', $image_icon_url)}" id="input_image_icon_url" />
	</div>
</div>
<div class="form-group row">
	<div class="col-12 col-sm-3 col-form-label required-label text-sm-end">{lang('ConfigAdmin.text_pagination_limit')}</div>
	<div class="col-12 col-sm-8 col-lg-6">
		{if !empty($settings.pagination_limit)}
			{assign var="pagination_limit" value="`$settings.pagination_limit`"}
		{else}
			{assign var="pagination_limit" value=""}
		{/if}
		<input type="text" name="pagination_limit" value="{old('pagination_limit', $pagination_limit)}" id="pagination_limit" class="form-control {if $validator->hasError("pagination_limit")}is-invalid{/if}">
		<div class="invalid-feedback">
...
<div class="form-group row">
	...
	<div class="col-12 col-sm-8 col-lg-6">
		{if !empty($settings.pagination_limit_admin)}
			{assign var="pagination_limit_admin" value="`$settings.pagination_limit_admin`"}
		{else}
			{assign var="pagination_limit_admin" value=""}
		{/if}
		<input type="number" name="pagination_limit_admin" value="{old('pagination_limit_admin', $pagination_limit_admin)}" id="pagination_limit_admin" class="form-control {if $validator->hasError("pagination_limit_admin")}is-invalid{/if}">
		<div class="invalid-feedback">
...
<div class="form-group row">
	...
	<div class="col-12 col-sm-8 col-lg-6 pt-2">
		{if !empty($settings.enable_scroll_menu_admin)}
			{assign var="enable_scroll_menu_admin" value="`$settings.enable_scroll_menu_admin`"}
		{else}
			{assign var="enable_scroll_menu_admin" value=""}
		{/if}
		<label class="form-check form-check-inline">
			<input type="radio" name="enable_scroll_menu_admin" value="{STATUS_ON}" {if !empty(old('enable_scroll_menu_admin', $enable_scroll_menu_admin))}checked="checked"{/if} id="enable_scroll_menu_admin_on" class="form-check-input">
			<label class="form-check-label" for="enable_scroll_menu_admin_on">ON</label>
		</label>
		<label class="form-check form-check-inline me-2">
			<input type="radio" name="enable_scroll_menu_admin" value="{STATUS_OFF}" {if empty(old('enable_scroll_menu_admin', $enable_scroll_menu_admin))}checked="checked"{/if} id="enable_scroll_menu_admin_off" class="form-check-input">
...
<div class="form-group row">
	...
	<div class="col-12 col-sm-8 col-lg-6 pt-2">
		{if !empty($settings.enable_icon_menu_admin)}
			{assign var="enable_icon_menu_admin" value="`$settings.enable_icon_menu_admin`"}
		{else}
			{assign var="enable_icon_menu_admin" value=""}
		{/if}
		<label class="form-check form-check-inline">
			<input type="radio" name="enable_icon_menu_admin" value="{STATUS_ON}" {if !empty(old('enable_icon_menu_admin', $enable_icon_menu_admin))}checked="checked"{/if} id="enable_icon_menu_admin_on" class="form-check-input">
			<label class="form-check-label" for="enable_icon_menu_admin_on">ON</label>
		</label>
		<label class="form-check form-check-inline me-2">
			<input type="radio" name="enable_icon_menu_admin" value="{STATUS_OFF}" {if empty(old('enable_icon_menu_admin', $enable_icon_menu_admin))}checked="checked"{/if} id="enable_icon_menu_admin_off" class="form-check-input">
...
<div class="form-group row">
	...
	<div class="col-12 col-sm-8 col-lg-6 pt-2">
		{if !empty($settings.enable_dark_mode)}
			{assign var="enable_dark_mode" value="`$settings.enable_dark_mode`"}
		{else}
			{assign var="enable_dark_mode" value=""}
		{/if}
		<label class="form-check form-check-inline">
			<input type="radio" name="enable_dark_mode" value="{STATUS_ON}" {if !empty(old('enable_dark_mode', $enable_dark_mode))}checked="checked"{/if} id="enable_dark_mode_on" class="form-check-input">
			<label class="form-check-label" for="enable_dark_mode_on">ON</label>
		</label>
		<label class="form-check form-check-inline me-2">
			<input type="radio" name="enable_dark_mode" value="{STATUS_OFF}" {if empty(old('enable_dark_mode', $enable_dark_mode))}checked="checked"{/if} id="enable_dark_mode_off" class="form-check-input">
