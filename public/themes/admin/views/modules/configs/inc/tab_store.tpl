{strip}
	...
	<div class="form-group row">
		...
		<div class="col-12 col-sm-8 col-lg-6">
			<input type="text" name="store_name" value="{old('store_name', $settings.store_name)}" id="input_store_name" placeholder="{lang('ConfigAdmin.text_store_name')}"
	...
	<div class="form-group row">
		...
		<div class="col-12 col-sm-8 col-lg-6">
			<input type="text" name="store_owner" value="{old('store_owner', $settings.store_owner)}" id="input_store_owner" placeholder="{lang('ConfigAdmin.text_store_owner_holder')}"
	...
	<div class="form-group row">
		<div class="col-12 col-sm-3 col-form-label required-label text-sm-end">{lang('ConfigAdmin.text_store_address')}</div>
		<div class="col-12 col-sm-8 col-lg-6">
			<textarea name="store_address" rows="5" placeholder="{lang('ConfigAdmin.text_store_address')}" id="input_store_address"
	...
	<div class="form-group row">
		...
		<div class="col-12 col-sm-8 col-lg-6">
			<input type="text" name="store_geocode" value="{old('store_geocode', $settings.store_geocode)}" id="input_store_geocode" placeholder="{lang('ConfigAdmin.text_store_geocode')}"
	...
	<div class="form-group row">
		...
		<div class="col-12 col-sm-8 col-lg-6">
			<input type="text" name="store_email" value="{old('store_email', $settings.store_email)}" id="input_store_email" placeholder="{lang('ConfigAdmin.text_store_email')}"
	...
	<div class="form-group row">
		...
		<div class="col-12 col-sm-8 col-lg-6">
			<input type="text" name="store_phone" value="{old('store_phone', $settings.store_phone)}" id="input_store_phone" placeholder="{lang('ConfigAdmin.text_store_phone')}"
	...
	<div class="form-group row">
		...
		<div class="col-12 col-sm-8 col-lg-6">
			<a href="javascript:void(0);" id="store_image" data-target="input_store_image" data-thumb="load_store_image" data-type="image" data-bs-toggle="image" class="mx-0 mt-1">
				<img src="{if !empty(old('store_image', $settings.store_image))}{image_thumb_url(old('store_image', $settings.store_image))}{else}{image_default_url()}{/if}" class="img-thumbnail w-100 me-1 img-fluid" alt="" title="" id="load_store_image" data-placeholder="{image_default_url()}"/>
			...
			<input type="hidden" name="store_image" value="{old('store_image', $settings.store_image)}" id="input_store_image" />
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-12 col-sm-8 col-lg-6">
			<textarea name="store_comment" rows="5" placeholder="{lang('ConfigAdmin.text_store_comment')}" id="input_store_comment"
