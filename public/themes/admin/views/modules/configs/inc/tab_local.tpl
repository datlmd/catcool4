...
<div class="form-group row">
	{lang('text_zone', 'text_zone', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_timezone', 'text_timezone', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="border-bottom mx-3 lead pb-1 my-3"></div>
<div class="form-group row">
	{lang('text_currency', 'text_currency', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="form-group row">
	{lang('text_currency_auto', 'text_currency_auto', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
...
<div class="border-bottom mx-3 lead pb-1 my-3"></div>
<div class="form-group row">
	{lang('text_length_class', 'text_length_class', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
		{form_dropdown('length_class', $length_class_list, set_value('length_class', $settings.length_class), ['class' => 'form-control'])}
	</div>
</div>
<div class="form-group row">
	{lang('text_weight_class', 'text_weight_class', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
	<div class="col-12 col-sm-8 col-lg-6">
