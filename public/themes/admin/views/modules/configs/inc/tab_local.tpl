{strip}
	...
	<div class="form-group row mb-3">
		...
		<div class="col-12 col-sm-8 col-lg-6">
			{form_dropdown('country', $country_list, old('country', $settings.country), ['class' => 'form-control country-changed cc-form-select-single', 'target_id' => '#input_country_zone'])}
		</div>
	</div>
	<div class="form-group row mb-3">
		<div class="col-12 col-sm-3 col-form-label text-sm-end">{lang('ConfigAdmin.text_zone')}</div>
		<div class="col-12 col-sm-8 col-lg-6">
			{form_dropdown('country_zone', $zone_list, old('country_zone', $settings.country_zone), ['id' => 'input_country_zone', 'class' => 'form-control zone-changed cc-form-select-single'])}
		</div>
	</div>
	<div class="form-group row mb-3">
