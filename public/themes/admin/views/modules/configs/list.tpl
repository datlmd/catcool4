			...
			<div class="row">
				...
				<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
					...
					<ul class="dropdown-menu" aria-labelledby="btn_group_drop_setting">
						<li><a class="dropdown-item" href="{site_url('manage/config_groups')}">{lang('Admin.text_group')}</a></li>
						<li><a class="dropdown-item" href="{site_url('manage/translations')}?module_id={lang('ConfigAdmin.translate_frontend_id')}">{lang("Admin.text_translate")}</a></li>
						<li><a class="dropdown-item" href="{site_url('manage/translations')}?module_id={lang('ConfigAdmin.translate_admin_id')}">{lang("Admin.text_translate_admin")}</a></li>
					</ul>
				</div>
			</div>
