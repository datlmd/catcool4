	...
	<div class="container-fluid  dashboard-content">
		<div class="row">
			...
			<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
				...
				<a href="{site_url('layouts/actions_manage')}" class="btn btn-sm btn-light btn-space">{lang('LayoutAdmin.text_action')}</a>
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">
									...
									{form_input('layout_id', set_value('layout_id', $request->getGet('layout_id'))|default:'', ['class' => 'form-control form-control-sm', 'placeholder' => lang('Admin.filter_id')])}
								</div>
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">
