{strip}
    ...
    <div class="container-fluid  dashboard-content">
        {form_open(uri_string(), ['id' => 'validationform'])}
            ...
            {if !empty($edit_data.return_status_id)}
                {form_hidden('return_status_id', $edit_data.return_status_id)}
            {/if}
            <div class="row">
                ...
                <div class="col-xl-10 col-lg-10 col-md-9 col-sm-12 col-12">
                    ...
                    <div class="card">
                        <h5 class="card-header"><i class="fas {if !empty($edit_data.return_status_id)}fa-edit{else}fa-plus{/if} me-2"></i>{$text_form}</h5>
                        <div class="card-body">
