	...
	<div class="container-fluid  dashboard-content">
		...
		<div class="row">
			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12">
				{include file=get_theme_path('views/inc/menu_localisation.inc.tpl') active="returns_statuses"}
			</div>
			...
			<div class="col-xl-10 col-lg-10 col-md-9 col-sm-12 col-12">
				...
				<div class="row">
					<div class="col-sm-7 col-12">
						{include file=get_theme_path('views/inc/breadcrumb.inc.tpl') heading_title=lang('ReturnStatusAdmin.heading_title')}
					</div>
					<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
						...
						{include file=get_theme_path('views/inc/button_translate.tpl') translate_frontend=lang('ReturnStatusAdmin.translate_frontend_id') translate_admin=lang('ReturnStatusAdmin.translate_admin_id')}
					</div>
				</div>

				<div class="card">
					<h5 class="card-header"><i class="fas fa-list me-2"></i>{lang('ReturnStatusAdmin.text_list')}</h5>
					<div class="card-body">
						{if !empty($list)}
										...
										<tr id="item_id_{$item.return_status_id}">
											...
											<td>
												<div class="switch-button switch-button-xs catcool-center">
													{form_checkbox("published_`$item.return_status_id`", ($item.published eq STATUS_ON) ? true : false, ($item.published eq STATUS_ON) ? true : false, ['id' => 'published_'|cat:$item.return_status_id, 'data-id' => $item.return_status_id, 'data-published' => $item.published, 'class' => 'change_publish'])}
													<span><label for="published_{$item.return_status_id}"></label></span>
												</div>
											</td>
											<td class="text-center">
												<div class="btn-group ms-auto">
													<a href="{site_url($manage_url)}/edit/{$item.return_status_id}" class="btn btn-sm btn-light" data-bs-toggle="tooltip" title="{lang('Admin.button_edit')}"><i class="fas fa-edit"></i></a>
