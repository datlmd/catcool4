{strip}
    ...
    <div class="container-fluid  dashboard-content">
        {form_open(uri_string(), ['id' => 'validationform'])}
            ...
            {if !empty($edit_data.return_action_id)}
                {form_hidden('return_action_id', $edit_data.return_action_id)}
            {/if}
            <div class="row">
                ...
                <div class="col-sm-9 col-12">
                    ...
                    <div class="card">
                        <h5 class="card-header"><i class="fas {if !empty($edit_data.return_action_id)}fa-edit{else}fa-plus{/if} me-2"></i>{$text_form}</h5>
                        <div class="card-body">
