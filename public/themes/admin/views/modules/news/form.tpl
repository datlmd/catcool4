                    ...
                    <div class="card">
                        ...
                        <div class="card-body collapse show" id="article_content_collapse">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value='{old("name", $edit_data.name)}' id="input_name" data-preview-title="seo_meta_title" data-title-id="input_meta_title" data-preview-slug="seo_meta_url" data-slug-id="input_slug" class="form-control {if empty($edit_data.news_id)}make-slug{/if} {if validation_show_error("name")}is-invalid{/if}">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <label class="form-check form-check-inline">
                                    <input type="radio" name="source_type" value="1" {if old('source_type', $edit_data.source_type)|default:1 eq 1}checked="checked"{/if} id="source_type_robot" class="form-check-input">
                                    <label class="form-check-label" for="source_type_robot">Robot</label>
                                </label>
                                <label class="form-check form-check-inline">
                                    <input type="radio" name="source_type" value="2" {if old('source_type', $edit_data.source_type)|default:1 eq 2}checked="checked"{/if} id="source_type_copy" class="form-check-input">
                                    <label class="form-check-label" for="source_type_copy">Copy</label>
                                </label>
                                <label class="form-check form-check-inline">
                                    <input type="radio" name="source_type" value="3" {if old('source_type', $edit_data.source_type)|default:1 eq 3}checked="checked"{/if} id="source_type_self_writing" class="form-check-input">
                                    <label class="form-check-label" for="source_type_self_writing">Self Writing</label>
                                </label>
                                <label class="form-check form-check-inline">
                                    <input type="radio" name="source_type" value="4" {if old('source_type', $edit_data.source_type)|default:1 eq 4}checked="checked"{/if} id="source_type_pr" class="form-check-input">
                                    <label class="form-check-label" for="source_type_pr">PR</label>
                                </label>
                                <label class="form-check form-check-inline">
                                    <input type="radio" name="source_type" value="5" {if old('source_type', $edit_data.source_type)|default:1 eq 5}checked="checked"{/if} id="source_type_translate" class="form-check-input">
