                    ...
                    <div class="card">
                        ...
                        <div class="card-body collapse show" id="article_content_collapse">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value='{old("name", $edit_data.name)}' id="input_name" data-preview-title="seo_meta_title" data-title-id="input_meta_title" data-preview-slug="seo_meta_url" data-slug-id="input_slug" class="form-control {if empty($edit_data.news_id)}make-slug{/if} {if $validator->hasError("name")}is-invalid{/if}">
