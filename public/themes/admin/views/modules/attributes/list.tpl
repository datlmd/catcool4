	...
	<div class="container-fluid  dashboard-content">
		<div class="row">
			...
			<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
				...
				<a href="{site_url('manage/attribute_groups')}" class="btn btn-sm btn-secondary btn-space" data-bs-toggle="tooltip" title="{lang('AttributeGroupAdmin.heading_title')}">{lang('AttributeGroupAdmin.heading_title')}</a>
