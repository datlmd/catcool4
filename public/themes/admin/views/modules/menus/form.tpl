    ...
    {form_open(uri_string(), ['id' => 'validationform'])}
        <div class="row">
            ...
            <div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
                ...
                <a href="{base_url($manage_url)}{http_get_query()}" class="btn btn-sm btn-secondary me-0 mb-0" title="{lang('Admin.button_cancel')}"><i class="fas fa-reply me-1"></i>{lang('Admin.button_cancel')}</a>
            </div>
        </div>
                                        ...
                                        <div class="form-group row required has-error">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-8">
                                                {if !empty($edit_data.menu_lang[$language.id].name)}
                                                    {assign var="name" value="`$edit_data.menu_lang[$language.id].name`"}
                                                {else}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-8">
                                                {if !empty($edit_data.menu_lang[$language.id].description)}
                                                    {assign var="description" value="`$edit_data.menu_lang[$language.id].description`"}
                                                {else}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-8">
                                                {if !empty($edit_data.menu_lang[$language.id].slug)}
                                                    {assign var="slug" value="`$edit_data.menu_lang[$language.id].slug`"}
                                                {else}
