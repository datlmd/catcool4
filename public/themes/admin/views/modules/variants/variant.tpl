			...
			<div class="col-12">
				...
				<div class="row">
					...
					<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
						...
						{include file=get_theme_path('views/inc/button_translate.tpl')
							translate_frontend=lang('VariantAdmin.translate_frontend_id')
							translate_admin=lang('VariantAdmin.translate_admin_id')
						}
					</div>
				</div>

				<div class="card">
					<h5 class="card-header"><i class="fas fa-list me-2"></i>{lang('VariantAdmin.text_list')}</h5>
					<div id="variant" class="card-body">

						{include file=get_theme_path('views/modules/variants/list.tpl')}
...
<script type="text/javascript">
	$('#variant').on('click', 'thead a, .pagination a', function (e) {
		e.preventDefault();

		$('#variant').load(this.href);
	});
</script>
