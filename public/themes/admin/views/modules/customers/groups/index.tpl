			...
			<div class="col-12">
				...
				<div class="row">
					...
					<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
						...
						{include file=get_theme_path('views/inc/button_translate.tpl') translate_frontend=lang('CustomerGroupAdmin.translate_frontend_id') translate_admin=lang('CustomerGroupAdmin.translate_admin_id')}
					</div>
				</div>
