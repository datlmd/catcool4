    ...
    {form_open(uri_string(), ['id' => 'user_validationform'])}
        ...
        <div class="row">
            ...
            <div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
                ...
                <a href="{site_url($manage_url)}" class="btn btn-sm btn-space btn-secondary mb-0"  data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="{lang('text_cancel')}"><i class="fas fa-reply"></i></a>
            </div>
        </div>
        <div class="row">
            {if !empty($errors)}
