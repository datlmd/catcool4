									...
									<tr>
										...
										<td class="text-center">
											<div class="btn-group ms-auto">
												...
												<a href="{$manage_url}/change_password/{$item.id}" class="btn btn-sm btn-outline-light" {if count($list) > 1}data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="{lang('text_change_password')}"{/if}><i class="fas fa-key"></i></a>
												<a href="{$manage_url}/permission/{$item.id}" class="btn btn-sm btn-outline-light text-brand" {if count($list) > 1}data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="{lang('text_permission_select')}"{/if}><i class="fas fa-lock-open"></i></a>
												<button type="button" data-id="{$item.id}" class="btn btn-sm btn-outline-light btn_delete_single text-danger" {if count($list) > 1}data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="{lang('button_delete')}"{/if}><i class="fas fa-trash-alt"></i></button>
											</div>
										</td>
