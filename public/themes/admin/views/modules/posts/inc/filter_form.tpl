{form_open(uri_string(), ['id' => 'filter_validationform', 'method' => 'get'])}
	<div class="row">
		...
		<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
			...
			{form_input('post_id', set_value('post_id', $request->getGet('post_id'))|default:'', ['class' => 'form-control form-control-sm', 'placeholder' => lang('Admin.filter_id')])}
		</div>
		<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
			...
			<select name="category_id" id="category_id" class="form-control">
				...
				{draw_tree_output_name(['data' => $category_list, 'key_id' => 'category_id'], $output_html, 0, $request->getGet('category_id'))}
			</select>
		</div>
		<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12 mb-2">
