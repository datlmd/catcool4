    ...
    <div class="container-fluid  dashboard-content form-confirm-leave">
        {form_open(uri_string(), ['id' => 'validationform'])}
            ...
            {if !empty($edit_data.post_id)}
                ...
                {assign var="post_id" value="`$edit_data.post_id`"}
            {else}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body collapse show" id="article_content_collapse">
                            <div class="form-group">
                                ...
                                {/if}
                                <input type="text" name="name" value='{old("name", $name)}' id="input_name" data-preview-title="seo_meta_title" data-title-id="input_meta_title" data-preview-slug="seo_meta_url" data-slug-id="input_slug" class="form-control {if empty($edit_data.post_id)}make-slug{/if} {if $validator->hasError("name")}is-invalid{/if}">
                            ...
                            <div class="form-group">
                                ...
                                <div id="category_review" class="w-100 p-3 bg-light">
                                    <ul class="list-unstyled bullet-check mb-0">
                                        {if !empty($post_id) && !empty(old('category_ids', $edit_data.category_ids))}
