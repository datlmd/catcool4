				...
				<div class="form-group row mt-3">
					...
					<div class="col-12 col-sm-8 col-lg-6">
						<div class="form-check ms-2">
							...
							<label class="form-check-label me-3" for="cb_backup_all">{lang('Admin.text_select_all')}</label>
						</div>
						<div id="tables" class="bg-light p-2" style="max-height: 400px; overflow-y: scroll;">
