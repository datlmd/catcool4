<div class="mb-4 text-end">
    ...
    <a href="{site_url('manage/country_provinces')}" class="btn btn-sm {if $active eq 'provinces'}btn-primary{else}btn-outline-primary{/if}">{lang('CountryAdmin.text_province')}</a>
