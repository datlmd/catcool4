						...
						<div class="card-body">
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">
									...
									{form_input('name', set_value('name', $filter.name), ['class' => 'form-control form-control-sm', 'placeholder' => lang('Admin.text_name')])}
								</div>
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">
									{lang('CountryWardAdmin.text_district')}
									{form_dropdown('district_id', $district_list, set_value('district_id', $filter.district_id), ['class' => 'form-control'])}
								</div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						{if !empty($list)}
							...
							{include file=get_theme_path('views/inc/paging.tpl') pager_name='wards'}
						{else}
