            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            {lang('text_formal_name', 'text_formal_name', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            {lang('text_country_code3', 'text_country_code3', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            {lang('text_country_type', 'text_country_type', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" name="country_type" value="{set_value('country_type', $edit_data.country_type)}" id="country_type" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            {lang('text_country_sub_type', 'text_country_sub_type', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            {lang('text_sovereignty', 'text_sovereignty', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" name="sovereignty" value="{set_value('sovereignty', $edit_data.sovereignty)}" id="sovereignty" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            {lang('text_capital', 'text_capital', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                                <input type="text" name="capital" value="{set_value('capital', $edit_data.capital)}" id="capital" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            {lang('text_currency_code', 'text_currency_code', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            {lang('text_currency_name', 'text_currency_name', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            {lang('text_country_number', 'text_country_number', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            {lang('text_internet_country_code', 'text_internet_country_code', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
                        ...
                        <div class="form-group row">
                            {lang('text_flags', 'text_flags', ['class' => 'col-12 col-sm-3 col-form-label text-sm-right'])}
                            <div class="col-12 col-sm-8 col-lg-6">
