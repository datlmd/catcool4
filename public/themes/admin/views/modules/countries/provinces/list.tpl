	...
	<div class="container-fluid  dashboard-content">
		<div class="row">
			...
			<div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
				...
				<a href="{site_url($manage_url)}/add{http_get_query()}" class="btn btn-sm btn-primary btn-space" title="{lang('CountryProvinceAdmin.text_add')}"><i class="fas fa-plus me-1"></i>{lang('CountryProvinceAdmin.text_add')}</a>
				...
				<div class="card">
					{form_open(uri_string(), ['id' => 'filter_validationform', 'method' => 'get'])}
						<div class="card-header">
							<div class="row">
								<div class="col-6">
									<h5 class="mb-0 mt-1 ms-2"><i class="fas fa-filter me-2"></i>{lang('CountryProvinceAdmin.filter_header')}</h5>
								</div>
								<div class="col-6 text-end">
									<button type="submit" class="btn btn-sm btn-primary"><i class="fas fa-search me-1"></i>{lang('CountryProvinceAdmin.filter_submit')}</button>
								</div>
							</div>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">
									{lang('CountryProvinceAdmin.filter_name')}
									{form_input('name', old('name', $filter.name), ['class' => 'form-control form-control-sm', 'placeholder' => lang('CountryProvinceAdmin.filter_name')])}
								</div>
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">
									{lang('CountryProvinceAdmin.text_country')}
									{form_dropdown('country_id', $country_list, old('country_id', $filter.country_id), ['class' => 'form-control'])}
								</div>

								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-2">
									{lang('CAdmin.text_limit')}
