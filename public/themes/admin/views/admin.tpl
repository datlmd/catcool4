	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			{foreach $hello as $key => $item}
				{$key}: {$item}<br/>
				{/foreach}
			<p>If you use my <a href="https://github.com/bkader/CodeIgniter" target="_blank">CodeIgniter Starter Kit</a>, each module can have its own admin area. All you need to do is to create the admin controller:</p>
			...
			<p>
				<ul>
					<li><code>../themes/<strong>theme_name</strong>/views/_modules/<strong>module_name</strong>/admin/<strong>view_file.php</strong></code></li>
