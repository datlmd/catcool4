{strip}
							...
							<div class="thumb-info-wrapper thumb-info-wrapper-opacity-6">
								...
								<div class="thumb-info-title bg-transparent p-4">
									...
									<div class="thumb-info-inner mt-1">
										<h2 class="font-weight-bold text-color-light line-height-2 text-5 mb-0">{$news.name}</h2>
									</div>
	...
	{*							</div>*}
								<h2 class="d-block line-height-3 font-weight-normal text-4 text-dark mb-0">
