{strip}
    ...
    {form_open($save, ["id" => "form_account_edit", "method" => "post", "data-cc-toggle" => "ajax", "data-alert" => "#account_edit_alert"])}
        ...
        <fieldset>
            ...
            <div class="form-group row mb-4 px-4">
                <label for="input_username" class="form-label fw-bold">{lang('Customer.text_username')}</label>
                <div class="col-12">
                    <input type="text" name="username" id="input_username" value="{old('username', $customer_info.username)}" placeholder="{lang('Customer.text_username')}" class="form-control {if validation_show_error('username')}is-invalid{/if}">
