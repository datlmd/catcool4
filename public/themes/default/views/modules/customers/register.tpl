    ...
    {form_open($register, ["id" => "form_register", "method" => "post", "data-cc-toggle" => "ajax", "data-alert" => "#register_alert"])}
        ...
        <fieldset>
            ...
            <div class="form-group row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="first_name" id="input_first_name" value="{old('first_name')}" placeholder="{lang('Customer.text_first_name')}" class="form-control {if $validator->hasError('first_name')}is-invalid{/if}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="last_name" id="input_last_name" value="{old('last_name')}" placeholder="{lang('Customer.holder_last_name')}" class="form-control {if $validator->hasError('last_name')}is-invalid{/if}">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-12">
                    <input type="text" name="email" id="input_email" value="{old('email')}" placeholder="{lang('Customer.text_email')}" class="form-control {if $validator->hasError('email')}is-invalid{/if}">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-12">
                    <input type="text" name="phone" id="input_phone" value="{old('phone')}" placeholder="{lang('Customer.text_phone')}" class="form-control {if $validator->hasError('phone')}is-invalid{/if}">
                    <div id="error_phone" class="invalid-feedback">{$validator->getError("phone")}</div>
                </div>
            </div>
        ...
        <fieldset class="mt-3">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-12">
                    <input type="password" name="password" id="input_password" value="" placeholder="{lang('Customer.text_password')}" class="form-control {if $validator->hasError('password')}is-invalid{/if}">
        ...
        <div class="form-group row mt-4 mb-2">
            <div class="col-12">
                ...
                <div id="error_agree" class="invalid-feedback">{$validator->getError("agree")}</div>
            </div>
        </div>
