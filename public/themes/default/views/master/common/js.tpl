...
<script type="text/javascript" src="{base_url('common/plugin/jquery.gmap/jquery.gmap.min.js')}"></script>
<script type="text/javascript" src="{base_url('common/plugin/jquery.lazyload/jquery.lazyload.min.js')}"></script>
