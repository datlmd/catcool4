<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?><div class="sixteen wide tablet ten wide computer column">
	{print_alert('This is a dummy alert just to show you how to display an alert using <strong>print_alert()</strong> function.')}
	<div class="ui segment">
		<h1 class="ui header" style="margin-top: 0;">Welcome to CodeIgniter!</h1>

		<p>The page you are looking at is being generated dynamically by CodeIgniter.</p>

		<p>If you would like to edit this page you'll find it located at:</p>
		<pre><code>www/content/themes/default/views/welcome.php</code></pre>
