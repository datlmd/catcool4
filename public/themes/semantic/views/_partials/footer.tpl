	...
	<div class="ui secondary menu">
		<div class="ui grid container">
			<div class="eight wide column">
				<p>&copy; <?php echo date('Y'); ?> - <?php echo @$site_title; ?> <a href="https://github.com/bkader" target="_blank">@bkader</a> &bull; Page rendered in: <strong>___elapsed_time___</strong> seconds.</p>.
			</div><!--/.column-->
			<div class="right aligned eight wide column">
				<div class="ui label" style="vertical-align: top;">
					Theme render time
					<div class="detail">___theme_time___</div>
				</div>
