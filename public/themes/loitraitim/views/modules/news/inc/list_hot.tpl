				...
				<div class="row">
					...
					<div class="col-4">
						<a href="{site_url($news.detail_url)}l">
							<img src="{if !empty($news.images.root)}{image_thumb_url($news.images.root)}{else}{image_thumb_url($news.images.robot)}{/if}" width="100%" alt="{$news.name}" class="image-grayscale">
						</a>
					</div>
				</div>
			</article>
