							...
							<td>
								<span style="font-family:Helvetica Neue,Helvetica,Lucida Grande,tahoma,verdana,arial,sans-serif;font-size:16px;line-height:21px;color:#141823">
									<span style="font-size:15px">
										...
										<p></p>
										{lang("Email.forgot_password_content_2", [anchor('manage/users/reset_password/'|cat:$forgotten_password_code, lang('Email.forgot_password_link', [], $language), 'style="color:#3b7b98"')], $language)}
										<p></p>
										...
										<table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
											...
											<tr>
												<td align="middle">
													<a href="{site_url('manage/users/reset_password/'|cat:$forgotten_password_code)}?redirect_from=button" style="color:#3b5998;text-decoration:none" target="_blank">
														<table border="0" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
															<tbody>
															<tr>
																<td style="border-collapse:collapse;border-radius:6px;text-align:center;display:block;border:none;background:#3b7b98;padding:6px 20px 10px 20px">
																	<a href="{site_url('manage/users/reset_password/'|cat:$forgotten_password_code)}?redirect_from=button" style="color:#3b5998;text-decoration:none;display:block" target="_blank">
																		<center>
																			<font size="3">
