...
trait DynaModelTrait
{
	...
	protected function addRelation($alias, $relationInfo):void
	{
		...
		{
			$related = \App\Models\DB::table($relationInfo['table']);
	 ...
	 * @param \App\Models\DynaModel $model model to be filtered
	 * @param string                             $table
	 */
    ...
    public function showQueryAll()
    {
        echo "<pre>";
        print_r($this->builder->getCompiledSelect());
        die;
    }
