...
class Plans extends AdminController
{
    ...
    private function _getForm($id = null)
    {
        ...
        if (!empty($id) && is_numeric($id)) {
            ...
            $data_languages = $this->model_lang->where('subscription_plan_id', $id)->findAll();
    ...
    public function delete($id = null)
    {
        ...
        if (!empty($this->request->getPost('is_delete')) && !empty($this->request->getPost('ids'))) {
            ...
            $list_delete = $this->model->getSubscriptionPlansByIds($ids, $this->language_id);
        ...
        $list_delete = $this->model->getSubscriptionPlansByIds($delete_ids, $this->language_id);
        if (empty($list_delete)) {
            json_output(['token' => $token, 'status' => 'ng', 'msg' => lang('Admin.error_empty')]);
        }
