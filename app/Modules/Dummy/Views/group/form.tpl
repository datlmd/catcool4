                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            {lang('Admin.text_name', 'text_name', ['class' => 'col-12 col-sm-3 col-form-label required-label text-sm-end'])}
                        ...
                        <div class="form-group row">
                            {lang('Admin.text_description', 'text_description', ['class' => 'col-12 col-sm-3 col-form-label text-sm-end'])}
                            <div class="col-12 col-sm-8 col-lg-6">
