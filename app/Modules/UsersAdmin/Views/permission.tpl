        ...
        {form_open(uri_string(), ['id' => 'user_validationform'])}
            ...
            <div class="row">
                ...
                <div class="col-sm-5 col-12 mb-2 mb-sm-0 text-end">
                    ...
                    <a href="{if previous_url() eq current_url() || strpos(previous_url(), $manage_url) === false}{site_url($manage_url)}{else}{previous_url()}{/if}" class="btn btn-sm btn-secondary mb-0" title="{lang('Admin.button_cancel')}"><i class="fas fa-reply me-1"></i>{lang('Admin.button_cancel')}</a>
                </div>
            </div>
            <div class="row">
