...
class ActionsManage extends AdminController
{
    ...
    public function index()
    {
        ...
        $layout_action_id = $this->request->getGet('layout_action_id');
        ...
        $filter = [
            'active'   => count(array_filter($this->request->getGet(['layout_action_id', 'name', 'limit']))) > 0,
            'layout_action_id' => $layout_action_id ?? "",
            'name'     => $name ?? "",
            'limit'    => $limit,
        ];
        ...
        $url = "";
        if (!empty($layout_action_id)) {
            $url .= '&layout_action_id=' . $layout_action_id;
        }
        if (!empty($name)) {
        ...
        $this->themes::load('actions/list', $data);
    }
    ...
    private function _getForm($id = null)
    {
        ...
        $this->themes::load('actions/form', $data);
    }
