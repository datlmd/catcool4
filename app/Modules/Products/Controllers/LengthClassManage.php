...
class LengthClassManage extends AdminController
{
    protected $errors = [];

    protected $model_lang;

    CONST MANAGE_ROOT = 'products/length_class_manage';
    CONST MANAGE_URL  = 'products/length_class_manage';
	...
	public function index()
	{
        ...
        $this->themes::load('length_class/list', $data);
	}
    ...
    private function _getForm($id = null)
    {
        ...
        $this->themes::load('length_class/form', $data);
    }
    ...
    public function delete($id = null)
    {
        ...
        json_output(['token' => $token, 'data' => $this->themes::view('length_class/delete', $data)]);
    }
}
