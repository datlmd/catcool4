...
class Categories extends AdminController
{
    ...
    public const MANAGE_ROOT = 'manage/product_categories';
    public const MANAGE_URL = 'manage/product_categories';
    ...
    public function add()
    {
        if (!empty($this->request->getPost())) {
            ...
            $add_data = [
                ...
                'top' => !empty($this->request->getPost('top')) ? STATUS_ON : STATUS_OFF,
    ...
    private function _getForm($id = null)
    {
        ...
        if (!empty($id) && is_numeric($id)) {
            ...
            $data_languages = $this->model_lang->where('category_id', $id)->findAll();
    ...
    public function delete($id = null)
    {
        ...
        if (!empty($this->request->getPost('is_delete')) && !empty($this->request->getPost('ids'))) {
            ...
            $list_delete = $this->model->getProductCategoriesByIds($ids, $this->language_id);
        ...
        $list_delete = $this->model->getProductCategoriesByIds($delete_ids, $this->language_id);
        if (empty($list_delete)) {
            json_output(['token' => $token, 'status' => 'ng', 'msg' => lang('Admin.error_empty')]);
        }
