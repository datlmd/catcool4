...
class App extends BaseConfig
{
     ...
     */
    public string $defaultLocale = 'vi'; //datlm
     ...
     * @var string[]
     */
    public array $supportedLocales = ['vi', 'en']; //datlm
     ...
     */
    public string $CSRFTokenName = 'csrf_token_catcool_cms'; //datlm
