...
defined('CACHE_TIME_CSS') OR define('CACHE_TIME_CSS', '20240928_2');
defined('CACHE_TIME_JS') OR define('CACHE_TIME_JS', '20240928');
...
defined('RESIZE_IMAGE_FB_WIDTH')    OR define('RESIZE_IMAGE_FB_WIDTH', 600);
defined('RESIZE_IMAGE_FB_HEIGHT')   OR define('RESIZE_IMAGE_FB_HEIGHT', 315);
