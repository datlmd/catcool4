...
return [
	...
	"help_address_1" => "12 Hoàng Diệu P8",
	"help_address_2" => "Căn hộ, toà nhà hoặc tầng",
	"help_safe" => "Đặt là True để khách hàng này không thuộc nhóm khách hàng chống gian lận",
	"password_change_successful" => "Đã thay đổi mật khẩu thành công",
	"text_add" => "Tạo tài khoản",
	"text_address_1" => "Địa chỉ",
	"text_address_2" => "Địa chỉ chi tiết",
	"text_address_add" => "Thêm mới Địa Chỉ",
	"text_address_default" => "Mặc định",
	"text_address_type" => "Loại địa chỉ",
	"text_address_type_home" => "Nhà riêng",
	"text_address_type_office" => "Văn phòng",
	...
	"text_customer_detail" => "Chi tiết Khách hàng",
