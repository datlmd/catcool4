...
return [
   ...
   'is_unique'             => 'Dữ liệu của {field} đã tồn tại. Vui lòng nhập lại thông tin với giá trị là duy nhất.',
   ...
   'required'              => '{field} là bắt buộc. Vui lòng nhập thông tin cho {field}',
   ...
   'valid_email'           => 'Giá trị của {field} không hợp lệ. Vui lòng nhập địa chỉ email chính xác.',
   'valid_emails'          => 'Giá trị của {field} không hợp lệ. Vui lòng nhập các địa chỉ email chính xác.',
