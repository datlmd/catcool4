...
return [
	...
	"text_dear" => "Dear {0},",
	"text_email" => "Email",
	"text_forgotten_change" => "To reset your password click on the link below:",
	"text_forgotten_greeting" => "A new password was requested for {0} customer account.",
	"text_forgotten_ip" => "The IP used to make this request was:",
	"text_forgotten_subject" => "{0} - Password reset request",
	...
	"text_reset_password" => "Change password",
